 ...
 <div class="modal fade" id="addVehicle" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="form-group">
          <label for="plateNumber1">Plate Number</label>
      ...
      <div class="form-group">
       <select name="make" id="make" class="form-control action" onclick="myFunction()" required>
        <option value="">Select Make</option>
        <?php echo $make; ?>
       </select><br>
       <select name="series" id="series" class="form-control action" required>
       ...
       <input type="text" class="form-control" name="otherseries" id="otherseries" placeholder="Enter Series" style="display: none;">
        ...
        <div class="form-group">
          ...
          <input class="form-control input-sm" type="number" class="form-control"  id="yearModel" name="yearModel" required="" oninvalid="this.setCustomValidity('Year Model is Invalid.')" oninput="setCustomValidity('')" pattern="[0-9]{1,20}">
        </div>
         <div class="form-group">
          <label for="color">Color</label><span style="color:red;"> *</span>
          <input class="form-control input-sm" type="text" name="color" required="" oninvalid="this.setCustomValidity('Color Model is Invalid.')" oninput="setCustomValidity('')" pattern="[A-Za-z]{1,20}" >
        </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn" name="vehicle_add" id="add_vehicle" style="background-color: #B80011; color: white"><i class="fa fa-car" aria-hidden="true"></i> Add Vehicle</button>
        ...
        <div class="modal-dialog">
          ...
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
            <div class="form-group">
            <label for="color">Color</label>
            <input type="text" class="form-control input-xs" id="color" name="color" value="<?php echo $row['color']; ?>"  oninvalid="this.setCustomValidity('Color Model is Invalid.')" oninput="setCustomValidity('')" pattern="[A-Za-z]{1,20}" >
          </div>
          </div>
