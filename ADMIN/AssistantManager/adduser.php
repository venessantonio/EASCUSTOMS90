                                        ...
                                        <div class="row">
                                          <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" name="first" oninvalid="this.setCustomValidity('First Name is Invalid.')" oninput="setCustomValidity('')" pattern="[A-Za-z]{1,20}" required>
                                            </div>
                                          </div>
                                          <div class="col-md-6">
                                            <div class="form-group">
